...
urlpatterns = [
    ...
    path("incapacidades/<int:pk>/pdf/", views.incapacidad_pdf, name="incapacidad_pdf"),
    path("incapacidades/<int:pk>/ia-analisis/", views.incapacidad_ia_analisis, name="incapacidad_ia_analisis"),
